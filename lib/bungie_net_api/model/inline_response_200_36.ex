...
defmodule BungieNetAPI.Model.InlineResponse20036 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20036 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :struct, BungieNetAPI.Model.DestinyResponsesDestinyVendorsResponse, options)
