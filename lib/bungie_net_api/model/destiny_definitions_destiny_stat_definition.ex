...
defmodule BungieNetAPI.Model.DestinyDefinitionsDestinyStatDefinition do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.DestinyDefinitionsDestinyStatDefinition do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"aggregationType", :struct, BungieNetAPI.Model.Object, options)
  end
end
