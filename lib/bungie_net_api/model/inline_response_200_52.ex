...
defmodule BungieNetAPI.Model.InlineResponse20052 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20052 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :struct, BungieNetAPI.Model.CommunityCommunityLiveStatus, options)
