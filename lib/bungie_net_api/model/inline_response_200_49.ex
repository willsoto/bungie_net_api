...
defmodule BungieNetAPI.Model.InlineResponse20049 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20049 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :struct, BungieNetAPI.Model.DestinyMilestonesDestinyMilestoneContent, options)
