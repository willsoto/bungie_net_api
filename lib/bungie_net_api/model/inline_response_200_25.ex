...
defmodule BungieNetAPI.Model.InlineResponse20025 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20025 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :struct, BungieNetAPI.Model.SearchResultOfGroupMemberApplication, options)
