...
defmodule BungieNetAPI.Model.InlineResponse20024 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20024 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :struct, BungieNetAPI.Model.GroupsV2GroupApplicationResponse, options)
