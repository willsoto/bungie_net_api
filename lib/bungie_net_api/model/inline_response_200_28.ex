...
defmodule BungieNetAPI.Model.InlineResponse20028 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20028 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :struct, BungieNetAPI.Model.GroupsV2GroupPotentialMembershipSearchResponse, options)
