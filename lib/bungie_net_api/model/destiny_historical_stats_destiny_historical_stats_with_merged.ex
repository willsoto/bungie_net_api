...
defmodule BungieNetAPI.Model.DestinyHistoricalStatsDestinyHistoricalStatsWithMerged do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.DestinyHistoricalStatsDestinyHistoricalStatsWithMerged do
