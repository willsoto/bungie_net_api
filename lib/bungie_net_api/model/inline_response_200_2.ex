...
defmodule BungieNetAPI.Model.InlineResponse2002 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse2002 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :list, BungieNetAPI.Model.UserGeneralUser, options)
