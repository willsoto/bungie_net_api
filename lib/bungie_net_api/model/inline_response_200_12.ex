...
defmodule BungieNetAPI.Model.InlineResponse20012 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"Response" => %{optional(String.t) => String.t},
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20012 do
