...
defmodule BungieNetAPI.Model.DictionaryComponentResponseOfint32AndDestinyItemPerksComponent do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.DictionaryComponentResponseOfint32AndDestinyItemPerksComponent do
