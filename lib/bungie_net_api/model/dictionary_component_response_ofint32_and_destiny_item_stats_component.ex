...
defmodule BungieNetAPI.Model.DictionaryComponentResponseOfint32AndDestinyItemStatsComponent do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.DictionaryComponentResponseOfint32AndDestinyItemStatsComponent do
