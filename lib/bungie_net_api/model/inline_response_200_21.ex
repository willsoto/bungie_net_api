...
defmodule BungieNetAPI.Model.InlineResponse20021 do
  @moduledoc """
...
defimpl Poison.Decoder, for: BungieNetAPI.Model.InlineResponse20021 do
  import BungieNetAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Response", :struct, BungieNetAPI.Model.SearchResultOfGroupMember, options)
